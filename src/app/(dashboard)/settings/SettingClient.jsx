...
export default function SettingClient() {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 h-[calc(100vh-64px)]">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 shadow-lg bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              className="flex items-center gap-2 px-4 py-2 text-white transition-all duration-200 transform rounded-lg shadow-md bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 hover:shadow-lg hover:scale-105"
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Card className="p-4 border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              <nav className="space-y-2">
                {[
                  { id: "profile", icon: User, label: "Thông tin cá nhân", desc: "Cập nhật thông tin tài khoản" },
                  { id: "notifications", icon: Bell, label: "Thông báo", desc: "Cài đặt thông báo" },
                  { id: "appearance", icon: Palette, label: "Giao diện", desc: "Tùy chỉnh giao diện" },
                  { id: "security", icon: Shield, label: "Bảo mật", desc: "Bảo vệ tài khoản" },
                  { id: "language", icon: Globe, label: "Ngôn ngữ", desc: "Cài đặt ngôn ngữ" },
                  { id: "password", icon: Key, label: "Mật khẩu", desc: "Đổi mật khẩu" },
                ].map((item) => (
                  <button
                    key={item.id}
            ...
            <Card className="p-8 bg-white/80 backdrop-blur-sm border-0 shadow-xl min-h-[600px]">
                  ...
                  <form className="space-y-6">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <input
                          type="text"
                          className="w-full px-4 py-3 transition-all duration-200 border border-gray-200 bg-gray-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          type="text"
                          className="w-full px-4 py-3 text-gray-500 bg-gray-100 border border-gray-200 cursor-not-allowed rounded-xl"
                    ...
                    <div className="flex justify-end pt-4">
                      <button
                        type="submit"
                        className="px-6 py-3 font-medium text-white transition-all duration-200 transform shadow-md bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl hover:from-blue-600 hover:to-indigo-700 hover:shadow-lg hover:scale-105"
                      >
                        Lưu thay đổi
                      </button>
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={item.key} className="flex items-center justify-between p-6 transition-all duration-200 bg-gray-50 rounded-xl hover:bg-gray-100 group">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-6">
                    <div className="p-6 bg-gray-50 rounded-xl">
                      <h3 className="mb-4 font-semibold text-gray-800">Chế độ hiển thị</h3>
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                        {[
                          ...
                          <label key={item.value} className="relative flex items-center p-4 transition-all duration-200 bg-white border-2 border-gray-200 cursor-pointer rounded-xl hover:border-blue-300 group">
                            <input
                              type="radio"
                              name="theme"
                              className="sr-only peer"
                            ...
                            />
                            <div className="flex items-center gap-3">
                              <div className="p-2 transition-colors bg-gray-100 rounded-lg group-hover:bg-blue-50">
                            ...
                            <div className="absolute w-4 h-4 transition-all -translate-y-1/2 border-2 border-gray-300 rounded-full right-4 top-1/2 peer-checked:bg-blue-500 peer-checked:border-blue-500"></div>
                          </label>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="p-6 bg-gray-50 rounded-xl">
                      <h3 className="mb-4 font-semibold text-gray-800">Kích thước font chữ</h3>
                      <select
              ...
              {activeTab === "security" && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-6 bg-gray-50 rounded-xl">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm text-gray-600">Bảo vệ tài khoản của bạn bằng xác thực 2 yếu tố</p>
                        </div>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    <div className="p-6 bg-gray-50 rounded-xl">
                      <h3 className="mb-4 font-semibold text-gray-800">Lịch sử đăng nhập</h3>
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={index} className="p-4 transition-colors bg-white border border-gray-200 rounded-xl hover:bg-gray-50">
                            <div className="flex items-center justify-between">
                              <div>
                                <p className="font-medium text-gray-800">{session.device}</p>
                                <p className="mt-1 text-sm text-gray-600">{session.location}</p>
                              </div>
              ...
              {activeTab === "language" && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-6">
                    <div className="p-6 bg-gray-50 rounded-xl">
                      <h3 className="mb-4 font-semibold text-gray-800">Ngôn ngữ hiển thị</h3>
                      <select
                        className="w-full px-4 py-3 transition-all duration-200 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        value={language}
                    ...
                    <div className="p-6 bg-gray-50 rounded-xl">
                      <h3 className="mb-4 font-semibold text-gray-800">Định dạng thời gian</h3>
                      <select
                        className="w-full px-4 py-3 transition-all duration-200 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        value={language}
                        onChange={(e) => handleLanguageChange(e.target.value)}
                ...
                <div className="space-y-6">
                  ...
                  <form className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full px-4 py-3 pr-12 transition-all duration-200 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div className="flex justify-end pt-4">
                      <button
                        type="submit"
                        className="px-6 py-3 font-medium text-white transition-all duration-200 transform shadow-md bg-gradient-to-r from-yellow-500 to-orange-600 rounded-xl hover:from-yellow-600 hover:to-orange-700 hover:shadow-lg hover:scale-105"
                      >
                        Đổi mật khẩu
                      </button>
                    </div>
