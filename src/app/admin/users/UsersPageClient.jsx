...
// Không cần AuthGuard nữa, đã được xử lý ở layout level
                ...
                {workers.map((worker) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <div>
                        <h3 className="font-medium text-gray-900">{worker.worker_full_name}</h3>
                        <p className="text-sm text-gray-600">{worker.worker_phone_company}</p>
                      </div>
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        ...
                        {worker.worker_status === 1 ? 'Hoạt động' : 'Không hoạt động'}
                      </span>
                    </div>
                  </div>
                ))}
